                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Contacts</a>
                            </li>
...
<div class="card-body">
    <div class="row">
        <div class="col-sm order-2 order-sm-1">
            <div class="d-flex align-items-start mt-5 mt-sm-3 gap-2 gap-lg-3">
                <div class="flex-shrink-0">
                    
                    
                        <img src="@if (!empty($profileData->photo)) {{ asset('upload/admin-images/'.$profileData->photo)}}  @else {{asset('upload/no-image/no_image.jpg') }} @endif" alt="" class="img-fluid rounded-circle d-block" style="width: 110px;  ">
                    </div>
...
<form action="{{ route('admin.change_password_submit') }}" method="post" enctype="multipart/form-data">
    @csrf
<div class="row">
    <div class="col-lg-6">
        <div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('password-confirmation') is-invalid @enderror" name="password-confirmation" type="password" id="password-confirmation">
